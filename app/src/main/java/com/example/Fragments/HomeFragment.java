...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        coffeeItems.add(new CoffeeItem(R.drawable.coffee01, "어도라블39","0","0"));
        coffeeItems.add(new CoffeeItem(R.drawable.coffee02, "오버더문","1","0"));
        coffeeItems.add(new CoffeeItem(R.drawable.coffee03, "때론347","2","0"));
        ...
        coffeeItems.add(new CoffeeItem(R.drawable.coffee07, "청년마카롱","6","0"));
        coffeeItems.add(new CoffeeItem(R.drawable.coffee08, "카페 오이사","7","0"));
        coffeeItems.add(new CoffeeItem(R.drawable.coffee09, "쁠레노케이크","8","0"));
