...
public class Gps extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton button = (ImageButton) findViewById(R.id.cafeButton);
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                        Snackbar.LENGTH_INDEFINITE).setAction("확인", view -> ActivityCompat.requestPermissions(Gps.this, REQUIRED_PERMISSIONS,
    ...
    public void showPlaceInformation(LatLng location) {
        ...
        new NRPlaces.Builder()
                .listener(Gps.this)
                .key("AIzaSyCMgSefkpoNXYwPR9wdNi6UGULQGhFbHf4")
