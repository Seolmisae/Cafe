...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText join_email, join_password, join_name, join_pwck, join_phnum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        join_phnum = findViewById(R.id.join_phnum);
        ...
        join_button.setOnClickListener(view -> {
            ...
            String UserNum = join_phnum.getText().toString();
            ...
            //서버로 Volley를 이용해서 요청
            RegisterRequest registerRequest = new RegisterRequest( UserEmail, UserPwd, UserName, UserNum, responseListener);
            RequestQueue queue = Volley.newRequestQueue( RegisterActivity.this );
